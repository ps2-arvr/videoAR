...
// モデル（メッシュ）
var geo = new THREE.PlaneGeometry(1, 1, 0.4, 0.4);            // plane ジオメトリ（サイズは 1x1x1）
...
var mesh1 = new THREE.Mesh(geo, new THREE.MeshBasicMaterial( { map: videoTexture } ));                 // メッシュを生成
mesh1.name = "plane";                                  // メッシュの名前（後でピッキングで使う）
